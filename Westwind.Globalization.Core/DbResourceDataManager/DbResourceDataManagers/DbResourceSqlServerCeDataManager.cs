...
GO
INSERT INTO [{0}] (ResourceId,Value,LocaleId,ResourceSet) VALUES ('HelloWorld','Hallo schn�de Welt (SqlCe)','de','Resources')
GO
...
";
        ...
        public DbResourceSqlServerCeDataManager(DbResourceConfiguration configuration) : base(configuration)
        {
        }
    }
}
